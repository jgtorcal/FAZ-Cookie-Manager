...
<div class="faz-wrap" id="faz-admin">
	<?php
	$faz_nav_items = array(
		'dashboard'    => array( 'slug' => 'cookie-law-info',              'label' => 'Dashboard' ),
		'banner'       => array( 'slug' => 'cookie-law-info-banner',       'label' => 'Cookie Banner' ),
		'cookies'      => array( 'slug' => 'cookie-law-info-cookies',      'label' => 'Cookies' ),
		'consent-logs' => array( 'slug' => 'cookie-law-info-consent-logs', 'label' => 'Consent Logs' ),
		'gcm'          => array( 'slug' => 'cookie-law-info-gcm',          'label' => 'Google Consent Mode' ),
		'languages'    => array( 'slug' => 'cookie-law-info-languages',    'label' => 'Languages' ),
		'settings'     => array( 'slug' => 'cookie-law-info-settings',     'label' => 'Settings' ),
	);
	?>
	<nav class="faz-top-nav" aria-label="FAZ Cookie Manager navigation">
		...
		<ul class="faz-top-nav-menu">
			<?php foreach ( $faz_nav_items as $nav_key => $nav_item ) :
				$is_current = ( $faz_page_slug === $nav_key ) || ( 'dashboard' === $nav_key && 'cookie-law-info' === $faz_page_slug );
			?>
